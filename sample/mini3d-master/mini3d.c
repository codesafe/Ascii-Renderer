...
// 원뿔 스크랩을 위해 cvv와 함께 좌표의 경계를 확인하십시오.
...
//=====================================================================
// 기하학 계산: 꼭짓점, 주사선, 가장자리, 직사각형, 스텝 계산
//=====================================================================
...
void device_draw_primitive(device_t *device, const vertex_t *v1, 
	...
	// 커팅, cvv 내 점 및 cvv와 교차하는 평면의 좌표 비율을 구체적으로 판단하기 위해 추가할 수 있습니다. 
	// 더 미세하게 재단하여 하나를 cvv 안에 완전히 있는 여러 개의 삼각형으로 분해한다.
	...
	if (render_state & (RENDER_STATE_TEXTURE | RENDER_STATE_COLOR)) {
		...
		vertex_rhw_init(&t1);	// 초기화 w
		vertex_rhw_init(&t2);	// 초기화 w
		vertex_rhw_init(&t3);	// 초기화 w
		
		// 분할 삼각형은 0-2개의 사다리꼴로 되어 있고 사용 가능한 사다리꼴의 수를 반환한다.
